// from erpnext/public/js/utils/serial_no_batch_selector.js#d7a5853
export default {
  ...
  validate: function () {
    ...
    if (this.has_batch && !this.has_serial_no) {
      ...
      if (!serial_nos || !serial_nos.replace(/\s/g, '').length) {
        frappe.throw(
          __('Please enter serial numbers for serialized item ' + values.item_code)
        );
        return false;
      }
      return true;
        ...
        fields: [
          {
            ...
            change: function () {
              ...
              if (me.warehouse_details.name) {
                ...
                this.set_value('');
                frappe.throw(
                  __(`Please select a warehouse to get available
									quantities`)
                );
              }
          ...
          },
          {
            ...
            change: function () {
              ...
              if (
                ...
                this.set_value('0');
                frappe.throw(
                  __(`For transfer from source, selected quantity cannot be

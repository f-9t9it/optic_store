...
def _get_columns():
    columns = [
        ...
        make_column("gross", "Gross", type="float",width=80),
        make_column("serv_discount", "Ser Disc", type="float",width=80),
        make_column("net", "Net", type="float",width=80),
        make_column("paid_amount", "Paid Amt", type="float",width=80),
        make_column("receipt_amount", "Receipt Amt", type="float",width=80),
        make_column("vat","VAT", type="float",width=60),
        make_column("total","Total", type="float",width=80),
        make_column("branch", type="Link", options="Branch",width=100),
        make_column("no_mop",label=_("NO MOP"), type="float", width=70),

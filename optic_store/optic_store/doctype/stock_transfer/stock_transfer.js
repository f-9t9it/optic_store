...
//     );
//     const { items } = frm.doc;
//     frm.brand_summary_vue = new windows.Vue({
//       data: { items },
...
// optic_store.scripts.stock_transfer_item = {
...
//  optic_store.scripts.stock_transfer = {
//   setup: set_queries,
...
//     {
//     setup: optic_store.scripts.stock_transfer.setup(frm),
//     refresh: optic_store.scripts.stock_transfer.refresh(frm)
//     }
//      );
